...
export default function CardStack({
  ...
  return (
    <div className="relative h-[540px] w-full" data-testid="card-stack">
      <AnimatePresence mode="popLayout">
        {thirdQuestion && thirdCategory && (
          ...
          >
            <div
              className="rounded-2xl p-8 min-h-[480px] shadow-md"
              style={{
        ...
        {nextQuestion && nextCategory && (
          ...
          >
            <div
              className="rounded-2xl p-8 min-h-[480px] shadow-lg"
              style={{
